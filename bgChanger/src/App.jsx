  ...
  <div className=' w-full h-screen duration-200' style={{ backgroundColor: color }}>
   ...
   <div className='flex flex-wrap justify-center gap-3 shadow-lg bg-white px-3 py-2 rounded-3xl'>
    ...
    <button onClick={() => setColor("Yellow")}
     className='outline-none px-4 py-1 rounded-full text-dark shadow-lg' style={{backgroundColor: "Yellow"}}>Yellow
    ...
    <button onClick={() => setColor("Pink")}
     className='outline-none px-4 py-1 rounded-full text-dark shadow-lg' style={{backgroundColor: "Pink"}}>Pink
    ...
    <button onClick={() => setColor("Lavender")}
     className='outline-none px-4 py-1 rounded-full text-dark shadow-lg' style={{backgroundColor: "Lavender"}}>Lavender
      
    </button>
    <button onClick={() => setColor("White")}
     className='outline-none px-4 py-1 rounded-full text-dark shadow-lg' style={{backgroundColor: "White"}}>White
